...
public class ProjectGrpcHandler extends
    ...
    public void getUserProjects(UserProjectsRequest request, StreamObserver<UserProjectsResponse> repObserver) {
        try {
            ...
            if (userId.isEmpty()) {
                repObserver.onError(Status.INVALID_ARGUMENT.withDescription("Invalid user id").asRuntimeException());
                return;
            }
    ...
    public void getProjectTaskBlueprint(TaskBlueprintRequest request,
        ...
        try {
            ...
            if (projectId.isEmpty()) {
                repObserver.onError(Status.INVALID_ARGUMENT.withDescription("Invalid project id").asRuntimeException());
                return;
            }
            ...
            TaskBlueprintResponse.Builder repBuilder = TaskBlueprintResponse.newBuilder()
                    ...
                    .setDescription(projectSummary.description() != null ? projectSummary.description() : "")
                    .setCurrentDateTime(
                            projectSummary.currentDateTime() != null ? projectSummary.currentDateTime() : "")
    ...
    public void createTask(CreateTaskRequest request,
        ...
        try {
            ...
            if (columnId.isEmpty()) {
                repObserver.onError(Status.INVALID_ARGUMENT.withDescription("Invalid column id").asRuntimeException());
                return;
            }
